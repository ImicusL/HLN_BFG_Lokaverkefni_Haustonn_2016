...
CREATE TABLE `weekdays` (
  `weekdayNumber` int(11) NOT NULL,
  `weekdayName` varchar(25) DEFAULT NULL,
  PRIMARY KEY (`weekdayNumber`),
  UNIQUE KEY `dayname_UQ` (`weekdayName`)
...
INSERT INTO `weekdays` VALUES (5,'Friday'),(1,'Monday'),(6,'Saturday'),(7,'Sunday'),(4,'Thursday'),(2,'Tuesday'),(3,'Wednesday');
...
-- Dump completed on 2016-11-21 12:43:48
